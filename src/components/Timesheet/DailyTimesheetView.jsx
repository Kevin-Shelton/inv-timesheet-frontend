            ...
            <div className="space-y-4">
              {timesheetData ? (
                <>
                    ...
                    <div className="flex items-center space-x-4 p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          <span className="text-lg font-semibold text-gray-900">{formatTime(timesheetData.time_in)}</span>
                  ...
                  {timesheetData.lunch_start && (
                    <div className="flex items-center space-x-4 p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          <span className="text-lg font-semibold text-gray-900">{formatTime(timesheetData.lunch_start)}</span>
                  ...
                  {timesheetData.break1_start && (
                    <div className="flex items-center space-x-4 p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          <span className="text-lg font-semibold text-gray-900">{formatTime(timesheetData.break1_start)}</span>
                  ...
                  {timesheetData.time_out && (
                    <div className="flex items-center space-x-4 p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2">
                          <span className="text-lg font-semibold text-gray-900">{formatTime(timesheetData.time_out)}</span>
                ...
                <div className="text-center py-12 bg-white border border-gray-200 rounded-lg">
                  ...
                  <p className="text-gray-500 mb-4">No time entries for this date</p>
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {expandedSections.trackedHours ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
                    </div>
                  </button>
                ...
                <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                  ...
                  >
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      {expandedSections.payrollHours ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
                    </div>
                  </button>
                  ...
                  {expandedSections.payrollHours && (
                    <div className="border-t border-gray-200 p-4 space-y-3 bg-gray-50">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium text-gray-900">{timesheetData.regular_hours || 0}h</span>
                      </div>
                      {timesheetData.overtime_hours > 0 && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Daily Overtime</span>
                          <span className="font-medium text-gray-900">{timesheetData.overtime_hours}h</span>
                        </div>
                      )}
                      {timesheetData.vacation_hours > 0 && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Vacation</span>
                          <span className="font-medium text-gray-900">{timesheetData.vacation_hours}h</span>
                        </div>
                      )}
                      {timesheetData.sick_hours > 0 && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Sick</span>
                          <span className="font-medium text-gray-900">{timesheetData.sick_hours}h</span>
                        </div>
                      )}
                      {timesheetData.holiday_hours > 0 && (
                        <div className="flex justify-between">
                          <span className="text-gray-600">Holiday</span>
                          <span className="font-medium text-gray-900">{timesheetData.holiday_hours}h</span>
                        </div>
                      )}
                    </div>
                  )}
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg shadow-sm">
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        {expandedSections.changeHistory ? <ChevronUp className="w-5 h-5 text-gray-400" /> : <ChevronDown className="w-5 h-5 text-gray-400" />}
                      </div>
                    </button>
